// const main_pedal_center = document.getElementById('main_pedal_center');


// main_pedal_center.addEventListener('click', () => {
...
const toggleButton = document.getElementById('toggleButton');
        ...
        toggleButton.addEventListener('click', function() {
            ...
            if (responseDiv.style.display === 'none' || responseDiv.style.display === '') {
                responseDiv.style.display = 'block'; // Show the div
                overlay.style.display = 'block'; // Show the overlay
                body.classList.add('blurred'); // Blur the background
            } else {
                responseDiv.style.display = 'none'; // Hide the div
